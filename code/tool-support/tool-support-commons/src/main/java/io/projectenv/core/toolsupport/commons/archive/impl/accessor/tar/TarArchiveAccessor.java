package io.projectenv.core.toolsupport.commons.archive.impl.accessor.tar;

import io.projectenv.core.toolsupport.commons.archive.impl.accessor.ArchiveAccessor;
...
public class TarArchiveAccessor implements ArchiveAccessor {
    ...
    private class TarArchiveEntry implements ArchiveEntry {
        ...
        public InputStream createInputStream() {
            return CloseShieldInputStream.wrap(inputStream);
        }
