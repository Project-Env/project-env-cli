...
import io.projectenv.process.ProcessOutputWriter;
...
public final class NativeImageHelper {
    ...
    public static void registerFieldsWithAnnotationForReflection(String basePackage, Class<? extends Annotation> annotationClazz) {
        PROCESS_INFO_WRITER.write("scanning package {0} for fields with annotation {1}", new Object[]{basePackage, annotationClazz.getSimpleName()});
